...
/*   Updated: 2023/12/02 19:28:01 by alexandm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#  define ROTATE_SPEED_MOUSE_INCREMENT	0.0001
# else
...
# define TAB 10;
# define WIDTH_HELP_MSG 350
# define HEIGHT_HELP_MSG 560
typedef enum e_commands
{
	...
	KEY_BIG_MAP			= XK_m,
	KEY_HELP			= XK_h,
	KEY_RESET_DEFAULT	= XK_0, // clique molette souris

//les kp ne marchent pas
	KEY_WALK_SPEED		= XK_1,
