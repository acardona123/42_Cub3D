...
static void	_gp_action_doors_chunks(t_general *gen, size_t time_now,
...
void	gp_action_doors(t_general *gen, size_t time_now, t_hitpoint *hit_pt)
{
	...
	_gp_action_doors_chunks(gen, time_now, door, face_to_update);
...
/**
 * @brief subfunction of gp_action_doors, updates the door data (status, adjacent
 *		textures)
 * 
 * @param gen 
 * @param time_now 
