...
/*   Updated: 2023/12/02 19:45:04 by alexandm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const int	g_offx = WIN_WIDTH / 2 - (WIDTH_HELP_MSG / 2);
static const int	g_offy = WIN_HEIGHT / 2 - (HEIGHT_HELP_MSG / 2);
...
/**
 * @brief Display commands settings on the screen and the terminal
 * 
 * @param gen 
 */
...
/**
 * @brief Display commands settings on the terminal 
 * 
 * @param gen 
 */
static void	_in_0_settings_help_msg_display(t_display *disp)
...
/**
 * @brief Display movement settings on the screen
 * 
 * @param disp 
 * @param line 
 * @param g_offx 
...
/**
 * @brief Display the customable settings on the screen
 * 
 * @param disp 
 * @param line 
 * @param g_offx 
...
/**
 * @brief displays commands settings with the a formated pattern
 * 
 * @param disp 
 * @param x 
 * @param y 
